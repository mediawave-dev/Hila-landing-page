  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-off-white">
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="font-serif text-4xl md:text-5xl font-light text-soft-black text-center mb-6">
          בואו נדבר
        </h2>
        <p className="text-center text-taupe font-light mb-16 max-w-md mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-soft-black text-off-white py-4 font-light text-sm hover:bg-warm-brown transition-colors duration-300"
            >
              שליחה בוואטסאפ
            </button>
          </form>
