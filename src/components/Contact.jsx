      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <form onSubmit={handleSubmit} className="scroll-reveal form-accent space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-whatsapp text-soft-black py-4 rounded-md font-light text-sm hover:bg-whatsapp-hover transition-colors duration-500"
            >
              שליחה ב-WhatsApp
            </button>
          </form>
          ...
          <div className="scroll-reveal flex flex-col justify-center space-y-8" style={{ transitionDelay: '0.15s' }}>
            ...
            >
              <div className="w-12 h-12 rounded-full bg-whatsapp flex items-center justify-center group-hover:bg-whatsapp-hover transition-colors duration-300">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-off-white">
            ...
            <a
              ...
              className="flex items-center gap-4 group"
            >
              <div className="w-12 h-12 rounded-full bg-phone flex items-center justify-center group-hover:bg-phone-hover transition-colors duration-300">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-off-white">
