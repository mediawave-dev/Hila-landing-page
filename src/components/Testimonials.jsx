    ...
    <section id="testimonials" className="py-24 md:py-32 bg-warm-tan">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-off-white/80 font-light leading-relaxed mb-6">
                {testimonial.text}
              </p>
              <p className="font-medium text-off-white/95 text-sm">
                {testimonial.name}
              </p>
        ...
        <div className="mt-20 md:mt-28">
          <p className="flex items-center justify-center gap-2 text-off-white/50 text-xs tracking-wide mb-10">
